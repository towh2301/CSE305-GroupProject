...
public class SecretaryHomePage extends javax.swing.JFrame {
    ...
    public SecretaryHomePage() {
        ...
        this.maintenanceFrame.setSize(400, 300);

        //setMess
        this.messFrame.setLocationRelativeTo(null);
        this.messFrame.setResizable(false);
        this.messFrame.setSize(400, 300);
    }
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("View mess");
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem2ActionPerformed(evt);
            }
        });
        staffMenu.add(jMenuItem2);

        jMenuItem1.setText("View maintenance");
    ...
    public static void addRowMessTable(Object[] object) {
        DefaultTableModel mess = (DefaultTableModel) messTable.getModel();
        mess.addRow(object);
    }
